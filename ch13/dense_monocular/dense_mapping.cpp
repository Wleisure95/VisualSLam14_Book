  ...
  bool one=true;
    ...
    for ( int x=boarder; x<width-boarder; x++ )
        ...
        for ( int y=boarder; y<height-boarder; y++ )
        {
            ...
            Vector2d pt_curr; 
	    int a=0;
	    if (x==boarder+300&&y==boarder+300)
	    {
	      a=1;
	    }
...
)
{
    ...
    double depth_estimation = d_esti.norm();   // 深度值 fanshu
...
//     Mat a=Mat(55,55,CV_8UC1,Scalar(0));
    imshow("ref", ref_show);
    imshow("curr", curr_show );
    waitKey();
